...
/**
 * Convenience UI class for represent image object in different dimensions. Each
 * image have 5 thumbnails with different size, background style, file prefix,
 * css class and background image. CurrentDimension field will be used to
 * determine rendering parameters used during page rendering process
 * 
...
public enum ImageDimension {
	...
	SIZE_80(80), SIZE_200(200), SIZE_MEDIUM(600), ORIGINAL(0);
	...
	public static ImageDimension getInstance(int x) {
		...
		return values()[ImageConstants.DEFAULT_IMAGE_SIZEVALUE];
	}
}
