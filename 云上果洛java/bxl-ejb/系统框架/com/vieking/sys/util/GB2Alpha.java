...
public class GB2Alpha {
	...
	public static String getAlpha(String sourceStr) {
		if (sourceStr == null || "".equals(sourceStr.trim())) {
			return null;
		} else {
			GB2Alpha g2a = new GB2Alpha();
			return g2a.String2Alpha(sourceStr);
		}

	}

	@SuppressWarnings("rawtypes")
	public Enum[] getEnumList(String clazzName) {
		try {
	...
	public static void main(String[] args) {
		...
		Enum[] m = obj1.getEnumList("com.vieking.sys.enumerable.CantonLevel");
		return;
	}
}
