...
public class UIHtmlText extends ITextComponent implements ValueHolder {
	...
	private StyleSheet getStyle() {
		...
		styles.loadTagStyle("li", "face", "STSong-Light");
		styles.loadTagStyle("span", "size", "8px");
		styles.loadTagStyle("sf", "color", "blue");
		styles.loadTagStyle("sf", "b", "");
		styles.loadTagStyle("classic", "color", "red");
		styles.loadTagStyle("classic", "i", "");
		styles.loadTagStyle("td", "face", "STSong-Light");
		styles.loadTagStyle("td", "encoding", "UniGB-UCS2-H");
		styles.loadTagStyle("td", "leading", "18,0");
		styles.loadTagStyle("body", "face", "STSong-Light");
		styles.loadTagStyle("body", "encoding", "UniGB-UCS2-H");
	...
	public Object getValue() {
		return valueBinding(FacesContext.getCurrentInstance(), "value",
				localValue);
	}
