...
@Name("fun.dangjianQuery")
@Scope(ScopeType.PAGE)
public class DangjianQuery extends BaseNqtQuery<Assistance> implements
Serializable{
	...
	public String queryHelpName() {
		return "qhb.fun.dangjianQuery";
	}

	@Override
	public String nameQueryName() {
		return "fun.dangjianQuery";
	}
}
